========================================================================
    KONSOLENANWENDUNG: BrotBoxEngineTest-Projektübersicht
========================================================================

Diese BrotBoxEngineTest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre BrotBoxEngineTest-Anwendung besteht.


BrotBoxEngineTest.vcxproj
...
BrotBoxEngineTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen BrotBoxEngineTest.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
