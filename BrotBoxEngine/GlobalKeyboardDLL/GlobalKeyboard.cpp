...
static bbe::Key vkToBbe(WPARAM vk)
{
	...
	{
	case VK_BACK:
		return bbe::Key::BACKSPACE;
	case VK_TAB:
		return bbe::Key::TAB;
	case VK_RETURN:
		return bbe::Key::ENTER;
	case VK_SHIFT:
		return bbe::Key::LEFT_SHIFT;
	case VK_CONTROL:
		return bbe::Key::LEFT_CONTROL;
	case VK_MENU:
		return bbe::Key::MENU;
	case VK_PAUSE:
		return bbe::Key::PAUSE;
	case VK_CAPITAL:
		return bbe::Key::CAPS_LOCK;
	case VK_ESCAPE:
		return bbe::Key::ESCAPE;
	case VK_SPACE:
		return bbe::Key::SPACE;
	case VK_LEFT:
		return bbe::Key::LEFT;
	case VK_UP:
		return bbe::Key::UP;
	case VK_RIGHT:
		return bbe::Key::RIGHT;
	case VK_DOWN:
		return bbe::Key::DOWN;
	case VK_INSERT:
		return bbe::Key::INSERT;
	case VK_DELETE:
		return bbe::Key::DELETE;
	case VK_OEM_PERIOD:
		return bbe::Key::PERIOD;
	case 0x30:
		return bbe::Key::_0;
	case 0x31:
		return bbe::Key::_1;
	...
	case VK_NUMPAD9:
		return bbe::Key::KP_9;
	case VK_MULTIPLY:
		return bbe::Key::KP_MULTIPLY;
	case VK_ADD:
		return bbe::Key::KP_ADD;
	case VK_SUBTRACT:
		return bbe::Key::KP_SUBTRACT;
	case VK_DECIMAL:
		return bbe::Key::KP_DECIMAL;
	case VK_DIVIDE:
		return bbe::Key::KP_DIVIDE;
	case VK_F1:
		return bbe::Key::F1;
	case VK_F2:
		return bbe::Key::F2;
	...
	case VK_F24:
		return bbe::Key::F24;
	case VK_NUMLOCK:
		return bbe::Key::NUM_LOCK;
	case VK_SCROLL:
		return bbe::Key::SCROLL_LOCK;
	case VK_LSHIFT:
		return bbe::Key::LEFT_SHIFT;
	case VK_RSHIFT:
		return bbe::Key::RIGHT_SHIFT;
	case VK_LCONTROL:
		return bbe::Key::LEFT_CONTROL;
	case VK_RCONTROL:
		return bbe::Key::RIGHT_CONTROL;
	case VK_LMENU:
		return bbe::Key::MENU;
	case VK_RMENU:
		return bbe::Key::MENU;
