...
namespace bbe
{
	...
	public:
		...
		template<typename dummyInternalType>
		typename std::enable_if<!std::is_same<InternalType, void>::value>::type
		setSeed(ExternalType seed)
		{
			static_assert(dummyInternalType == InternalType, "Do not specify dummy template argument!");
