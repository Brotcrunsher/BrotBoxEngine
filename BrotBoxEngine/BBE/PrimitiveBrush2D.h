...
namespace bbe
{
	...
	public:
		static constexpr const char* DEFAULT_FONT_NAME = "OpenSansRegular.ttf";
		...
		void fillVertexIndexList(const uint32_t *indices, size_t amountOfIndices, const bbe::Vector2 *vertices, size_t amountOfVertices);
	};
}
